      ...
      <div className="generator-container">
        <div className="controls">
          <div className="control-section">
            ...
            <div className="control-group">
              <label htmlFor="codeType" className="tooltip-label">
                ...
                <span className="tooltip">
                  Pilih jenis code yang ingin dibuat. QR Code untuk data
                  kompleks (URL, text panjang), Barcode untuk angka/text
                  sederhana
                </span>
              </label>
              <select
                ...
                <option value="BARCODE">
                  🏷️ Barcode (Untuk Produk, Inventory)
                </option>
              </select>
            </div>
            ...
            <div className="control-group">
              <label htmlFor="text">
                {codeType === "QR" ? "Text/URL/Data:" : "Text/Number:"}:
              </label>
              <textarea
                id="text"
                value={text}
                ...
                placeholder={
                  codeType === "QR"
                    ? "Masukkan text, URL, atau data lainnya"
                    : "Masukkan text atau angka"
                }
            ...
            {codeType === "BARCODE" && (
              <div className="control-group">
                <label htmlFor="format" className="tooltip-label">
                  Barcode Format:
                  <span className="tooltip">
                    Pilih format barcode sesuai kebutuhan. CODE128 untuk
                    text/angka umum, EAN13 untuk produk retail
                  </span>
                </label>
                <select
                  id="format"
                  ...
                  <option value="CODE128">
                    CODE128 - Umum untuk text/angka
                  </option>
                  <option value="CODE39">CODE39 - Industri/inventory</option>
                  <option value="EAN13">
                    EAN13 - Produk retail (13 digit)
                  </option>
            ...
            {codeType === "QR" && (
              <div className="control-group">
                <label htmlFor="qrErrorLevel" className="tooltip-label">
                  Error Correction:
                  <span className="tooltip">
                    Level koreksi error QR Code. Semakin tinggi, semakin tahan
                    terhadap kerusakan tapi QR lebih complex
                  </span>
                </label>
                <select
                  id="qrErrorLevel"
                  ...
                  <option value="Q">
                    Quartile (~25%) - Tahan lecet ringan
                  </option>
          ...
          <div className="control-section">
            ...
            <div className="control-group">
              <label htmlFor="backgroundType" className="tooltip-label">
                Background Type:
                <span className="tooltip">
                  Pilih jenis background: Solid (warna polos), Gradient (gradasi
                  warna), Pattern (pola)
                </span>
              </label>
              <select
            ...
            <div className="control-group">
              <label htmlFor="lineColor">
                {codeType === "QR" ? "QR Color:" : "Code Color:"}:
              </label>
              <div className="color-input">
                <input
                  id="lineColor"
        ...
        <div className="preview-section">
          <div className="preview-header">
            ...
            <div className="preview-info">
              <span className="info-item">
                Type: <strong>{codeType}</strong>
              </span>
              {codeType === "QR" && (
                <span className="info-item">
                  Size: <strong>{qrSize}px</strong>
                </span>
              )}
            </div>
          </div>
          ...
          <div
            className={`barcode-preview ${backgroundType} ${
              shadow ? "with-shadow" : ""
            }`}
            ref={downloadRef}
            style={{
        ...
        <div className="help-content">
          ...
          <div className="help-grid">
            <div className="help-item">
              <h4>🔲 QR Code</h4>
              <p>
                Cocok untuk: URL website, kontak, WiFi, lokasi, email, dan data
                text panjang. Bisa discan oleh smartphone.
              </p>
            </div>
            <div className="help-item">
              <h4>🏷️ Barcode</h4>
              <p>
                Cocok untuk: produk retail, inventory, nomor seri. Butuh scanner
                khusus barcode.
              </p>
            </div>
            <div className="help-item">
              <h4>🎨 Background</h4>
              <p>
                Solid: warna polos. Gradient: gradasi 2 warna. Pattern: pola
                dekoratif (coming soon).
              </p>
            </div>
            <div className="help-item">
              <h4>📥 Download</h4>
              <p>
                PNG: untuk print dan web. SVG: untuk desain, bisa resize tanpa
                pecah.
              </p>
            </div>
          </div>
